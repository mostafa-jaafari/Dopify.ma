...
export default function ProcessCard({IMAGE, TITLE, DESCRIPTION}: {IMAGE:string; TITLE:string;DESCRIPTION:string;}) {
  return (
    <div className='w-[350px] grow border border-neutral-200 space-y-2 flex flex-col items-center p-8 min-h-[300px] rounded-lg shadow-lg hover:-translate-y-4 transition-all'>
