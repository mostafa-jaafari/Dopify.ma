...
export function HeaderUnderHeader(){
    ...
    return (
        <main className="bg-neutral-100 backdrop-blur-sm sticky top-0 z-10 w-full lg:px-20 py-4 border-b border-blue-600 border-dashed">
            <ul className="Scroll-Animation w-max flex gap-6">
    ...
    return (
        <main className="w-full flex items-center justify-between bg-neutral-100 py-3 lg:px-20">
            ...
            <section className="flex gap-8">
                <Link href='/' className="py-1 px-4 rounded-lg bg-blue-600 text-neutral-100 font-semibold">Register</Link>
                <Link href='/' className="px-2 text-blue-600 border-b-2 border-blue-600 font-semibold">Login</Link>
            </section>
        </main>
    )
}