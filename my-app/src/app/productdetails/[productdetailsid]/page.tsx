...
export default async function page({params}){
    ...
    return (
        <main className="w-full min-h-screen flex flex-col items-center">
            <section className="w-full flex items-center justify-between py-2 px-20 border border-neutral-200">
                <h1>
                    Logo
                </h1>
            ...
            <div className="w-max my-2 px-6 py-2 flex items-center gap-2 rounded-full shadow text-sm bg-orange-300/20 border border-orange-200 text-neutral-600">
                <Info size={18}/>
            ...
            <section className="w-full flex gap-4 py-10 px-20">
                ...
                <DesignSection PRODUCTID={ProductId}/>
            </section>
        </main>
    )
}